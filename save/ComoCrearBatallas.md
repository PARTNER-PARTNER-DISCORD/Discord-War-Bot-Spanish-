# Ejemplo de creación de batallas
  ...
  - `"outcome": "nothing",` - Estado del atacante/victima al terminar la acción.
    ...
    - `"weapon": { "name": "*", "count": ** }` - Objeto conseguido por atacantes/victimas.
      - `*` - Nombre del arma/consumible:
        ...
        - `madera`
      - `**` - Cantidad
  - `"killer": true` - Es el autor del asesinato

### Ejemplos más avanzados

```json
    {
      "message": "{attacker} encuentra una granada en la cornucopia.",
      "attacker": { "count": "1", "outcome": "nothing", "weapon": { "name": "granada", "count": 1 } },
...
```json
    {
      "message": "{victim} agarra una pistola con 6 balas en ella.",
      "attacker": { "count": "0", "outcome": "nothing" },
      "victim": { "count": "1", "outcome": "nothing", "weapon": {"name": "pistola", "count": 6 } }
    }
```

```json
    {
      "message": "{victim} agarra una pistola que puede funcionar o no",
      "attacker": { "count": "0", "outcome": "nothing" },
      "victim": { "count": "1", "outcome": "nothing", "weapon": {"name": "pistola", "count": 6 } }
    },
    {
...
```json
    {
      "message": "{victim} agarra una pistola que definitivamente no funciona",
      "attacker": { "count": "0", "outcome": "nothing" },
      "victim": { "count": "1", "outcome": "nothing" }
    }
```
...
```json
    {
      "message": "{attacker} encuentra una pistola con una bala, y mata a {victim} con ella",
      "attacker": { "count": "1", "outcome": "nothing", "killer": true },
      "victim": { "count": "1", "outcome": "dies" }
    }
```
...
```json
    {
      "message": "{attacker} encuentra una pistola con una bala, e intenta matar a {victim} con ella pero falla",
...
```json
    {
      "message": "{attacker} encuentra un arma con una sola bala y {victim} mueren de alguna manera",
      "attacker": { "count": "1", "outcome": "nothing", "killer": true },
...
```json
    {
      "message": "{victim} termina[V|n] con su[V|s] vida[V|s] con [Vun |]cuchillo[V|s] de mantequilla",
      "attacker": { "count": "0", "outcome": "nothing" },
      "victim": { "count": "-1", "outcome": "dies" }
    }
```
